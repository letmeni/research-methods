...
DESCRIPTIVES VARIABLES=compromise gender ftsci fttrump
...
DATASET ACTIVATE DataSet1.
RECODE ftsci (998=SYSMIS) (ELSE=Copy) INTO ftsci_recoded.
EXECUTE.


DESCRIPTIVES VARIABLES=compromise gender ftsci fttrump ftsci_recoded fttrump_recoded
  /STATISTICS=MEAN STDDEV MIN MAX.
...
GRAPH
  /SCATTERPLOT(BIVAR)=ftsci_recoded WITH fttrump_recoded
  /MISSING=LISTWISE.

CORRELATIONS
  /VARIABLES=ftsci_recoded fttrump_recoded
  /PRINT=TWOTAIL NOSIG
  /MISSING=PAIRWISE.
